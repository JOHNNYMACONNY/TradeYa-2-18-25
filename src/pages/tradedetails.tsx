            ...
            <div className="flex items-center">
              <span className={`
                ...
                ${trade.status === 'open' ? 'bg-green-100 text-green-800' :
                  trade.status === 'reserved' ? 'bg-blue-100 text-blue-800' :
                  trade.status === 'in_progress' ? 'bg-yellow-100 text-yellow-800' :
            ...
            <div className="space-y-3">
              {trade.status === 'open' && (
                <>
                  <button
                    ...
                    disabled={updatingStatus}
                    className="w-full flex items-center justify-center gap-2 bg-blue-100 text-blue-800 px-4 py-2 rounded hover:bg-blue-200"
                  >
              ...
              {(trade.status === 'reserved' || trade.status === 'in_progress' || trade.status === 'completed') && (
                <button
                  ...
                  disabled={updatingStatus}
                  className="w-full flex items-center justify-center gap-2 bg-red-100 text-red-800 px-4 py-2 rounded hover:bg-red-200"
                >
                  Cancel Trade
                </button>
              )}
